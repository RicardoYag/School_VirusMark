...
class Data:
    def __init__(self, school: str, sno: str, jing: float, wei: float, province: str, city: str, district: str, street: str) -> None:
    ...
    def post(self):
        try:
            url = 'https://fxgl.jx.edu.cn/' + self.school + '/public/homeQd?loginName=' + self.sno + '&loginType=0'
...
def main(*args):
    ...
    data = Data("4136010406", "19201125", 115.827729,28.649887, "江西省", "南昌市", "红谷滩区", "丰和南大道696号南昌航空大学")
    # 上传打卡数据
    data.post()
    # 验证打卡
    data.verify()
